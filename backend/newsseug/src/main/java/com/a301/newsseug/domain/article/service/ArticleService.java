...
import com.a301.newsseug.external.redis.service.ArticleCounterService;
...
public class ArticleService {
    ...
    private final ArticleCounterService redisCounterService;
...
//        Article article = articleRepository.getOrThrow(articleId);
        ...
        Long hateCount = redisCounterService.getHateCount(articleId);
